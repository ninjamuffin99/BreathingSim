...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/breathIn.png", __ASSET__assets_images_breathin_png);
		type.set ("assets/images/breathIn.png", AssetType.IMAGE);
...
@:keep @:bind #if display private #end class __ASSET__assets_images_breathin_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:image("assets/images/breathIn.png") #if display private #end class __ASSET__assets_images_breathin_png extends lime.graphics.Image {}
